      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="border rounded-lg p-3">
            ...
            <input
              type="date"
              value={bookingDetails.transferInitiated}
              onChange={(e) => setBookingDetails(prev => ({ ...prev, transferInitiated: e.target.value }))}
          ...
          <div className="border rounded-lg p-3">
            ...
            <input
              type="date"
              value={bookingDetails.transferCompleted}
              onChange={(e) => setBookingDetails(prev => ({ ...prev, transferCompleted: e.target.value }))}
              className="w-full text-sm font-medium bg-transparent border-none p-0 focus:outline-none"
              placeholder="Add date"
            />
          </div>
